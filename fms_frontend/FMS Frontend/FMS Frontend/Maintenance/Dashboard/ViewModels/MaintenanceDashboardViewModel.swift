...
class MaintenanceDashboardViewModel: ObservableObject {
    ...
    @Published var recentAlerts: [MaintenanceAlert] = [
        MaintenanceAlert(title: "Pre-Trip Inspection Required", message: "Vehicle V-102 is ready for inspection.", type: .inspection, time: "10 mins ago"),
        MaintenanceAlert(title: "Urgent Maintenance", message: "Driver reported brake issues for V-205.", type: .maintenance, time: "1 hour ago")
    ]
